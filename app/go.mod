module github.com/kakkky/kakkky.dev
...
require (
	...
	github.com/getsentry/sentry-go/slog v0.49.0 // indirect
	...
	github.com/testcontainers/testcontainers-go/modules/localstack v0.44.0 // indirect
